use noise::{NoiseFn, Seedable, SuperSimplex, Value, Worley};
use rand::SeedableRng;
use std::collections::HashMap;

use crate::generation::{Biome, Factors, Foliage, Soil};
...
impl Generator {
    ...
    fn make_soil(&mut self, x: i32, y: i32) -> Soil {
        ...
        let spectrum = [
            Sand, Sand, Chalk, Silt, Clay, Clay, Sand, Chalk, Chalk, Silt, Clay, Clay, Chalk,
            Chalk, Silt, Clay, Clay, Clay, Chalk, Silt, Silt, Loam, Peat, Peat, Silt, Silt, Loam,
            Loam, Peat, Peat, Silt, Loam, Loam, Loam, Peat, Peat,
        ];
